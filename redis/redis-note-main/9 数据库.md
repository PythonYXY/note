...
==`EXPIREAT`或`PEXPIREAT`命令，以秒或毫秒精度为某个键设置过期时间，过期时间是一个UNIX时间戳。主从模式下建议使用EXPIREAT和PEXPIREAT==
...
==新版redis从服务不会返回过期键：==https://blog.csdn.net/itomge/article/details/121298609?utm_medium=distribute.pc_feed_v2.none-task-blog-expert_recommend-3.pc_personrecdepth_1-utm_source=distribute.pc_feed_v2.none-task-blog-expert_recommend-3.pc_personrec
